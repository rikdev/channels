...
int main()
{
	...
	one_thread_executor executor{cancellation_token_source};

	inefficient_timer timer{1s, cancellation_token_source};
	inefficient_timer::channel_type timer_channel = timer.get_channel();
